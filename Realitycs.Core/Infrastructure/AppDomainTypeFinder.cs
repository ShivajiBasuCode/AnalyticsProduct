...
namespace RealityCS.Core.Infrastructure
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IRealitycsFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(IRealitycsFileProvider fileProvider = null)
        {
            _fileProvider = fileProvider ?? RealitycsCommonHelper.DefaultFileProvider;
        }
