...
namespace RealityCS.Core.Infrastructure
{
    /// <summary>
    /// Represents Nop engine
    /// </summary>
    public class RealitycsEngine : IEngine
    {
        #region Fields
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new RealitycsException("Unknown dependency");
                        return service;
                    });
            ...
            throw new RealitycsException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
