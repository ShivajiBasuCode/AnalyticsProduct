...
using RealityCS.Core.Configuration;
...
namespace RealityCS.Core.Helper
{
    /// <summary>
...
//IActionContextAccessor actionContextAccessor,
        ...
        public virtual string GetCurrentIpAddress()
        {
            ...
            try
            {
                ...
                if (_httpContextAccessor.HttpContext.Request.Headers != null)
                {
                    ...
                    var forwardedHttpHeaderKey = RealitycsHttpDefaults.XForwardedForHeader;
        ...
        public virtual string GetCurrentRequestUrl(bool includeQueryString, bool? useSsl = null, bool lowercaseUrl = false)
        {
            if (!IsRequestAvailable())
                return string.Empty;
        ...
        public virtual string GetStoreLocation(bool? useSsl = null)
        {
            ...
            if (string.IsNullOrEmpty(storeHost))
            {
                ...
                storeLocation = "";// RealitycsEngineContext.Current.Resolve<IStoreContext>().CurrentStore?.Url
        ...
        public virtual T QueryString<T>(string name)
        {
            ...
            return RealitycsCommonHelper.To<T>(_httpContextAccessor.HttpContext.Request.Query[name].ToString());
        }
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items[RealitycsHttpDefaults.IsPostBeingDoneRequestItem] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items[RealitycsHttpDefaults.IsPostBeingDoneRequestItem]);
            }

            set => _httpContextAccessor.HttpContext.Items[RealitycsHttpDefaults.IsPostBeingDoneRequestItem] = value;
        }
