...
namespace RealityCS.SharedMethods.FileProvider
{
    /// <summary>
    /// IO functions using the on-disk file system
    /// </summary>
    public class RealitycsFileProvider : PhysicalFileProvider, IRealitycsFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a NopFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public RealitycsFileProvider(IWebHostEnvironment webHostEnvironment)
