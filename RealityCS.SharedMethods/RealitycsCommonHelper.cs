...
namespace RealityCS.SharedMethods
{
    ...
    /// </summary>
    public partial class RealitycsCommonHelper
    {
        #region Fields
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new RealitycsException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new RealitycsException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new RealitycsException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        /// </summary>
        public static IRealitycsFileProvider DefaultFileProvider { get; set; }
