...
{
    public static class RealitycsConstants
    {
        public static string LogRequestParameters => "RequestParameters";
        ...
        {
            public const string DataSourceElementEntityName = "DataSourceElements";
            public const string DataSourceElementEntityDescription = "Stored the value of data source elements";

            public const string DataSourceEntityName = "DataSource";
            public const string DataSourceEntityDescription = "Stored the value of data source";

        }
        public static class KpiElements
        {

            public const string kpiEntityName = "KPI  Elements";
            public const string kpiEntityDescription = "Hold KPI Elements";

            public const string BenchMarkEntityName = "BenchMark";
            public const string BenchMarkEntityDescription = "Hold BenchMark";


            public const string ThresholdEntityName = "Threshold";
            public const string ThresholdEntityDescription = "Hold Threshold";

        }
        public static class GraphicalElements
        {
            public const string DashboardEntityName = "DashBoard";
            public const string DashboardEntityDescription = "Hold DashBoard Elements";

            public const string CardEntityName = "Card";
            public const string CardEntityDescription = "Hold Card Elements";

        }
        #region Settings
        public static class SecuritySettings
        {
            public const string EncryptionKey = "9878686857473645";
        }
        ...
        public static class CustomerSettings
        {
            ...
            /// </summary>
            public const bool UsernamesEnabled = false;
            ...
            /// </summary>
            public const string HashedPasswordFormat = "SHA512";
