...
//        public EntityDescriptor GetEntityDescriptor<TEntity>() where TEntity : RealitycsBase
//        {
...
//        public virtual ITable<TEntity> GetTable<TEntity>() where TEntity : RealitycsBase
//        {
...
//        public TEntity InsertEntity<TEntity>(TEntity entity) where TEntity : RealitycsBase
//        {
...
//        /// <typeparam name="TEntity">Entity type</typeparam>
//        public void UpdateEntity<TEntity>(TEntity entity) where TEntity : RealitycsBase
//        {
//            using var dataContext = CreateDataConnection();
...
//        /// <typeparam name="TEntity">Entity type</typeparam>
//        public void DeleteEntity<TEntity>(TEntity entity) where TEntity : RealitycsBase
//        {
//            using var dataContext = CreateDataConnection();
...
//        /// <typeparam name="TEntity">Entity type</typeparam>
//        public void BulkDeleteEntities<TEntity>(IList<TEntity> entities) where TEntity : RealitycsBase
//        {
//            using var dataContext = CreateDataConnection();
...
//        /// <typeparam name="TEntity">Entity type</typeparam>
//        public void BulkDeleteEntities<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : RealitycsBase
//        {
//            using var dataContext = CreateDataConnection();
//            dataContext.GetTable<TEntity>()
//                .Where(predicate)
...
//        /// <typeparam name="TEntity">Entity type</typeparam>
//        public void BulkInsertEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : RealitycsBase
//        {
