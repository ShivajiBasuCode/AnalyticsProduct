...
namespace RealityCS.DataLayer.BaseContext
{
    /// <summary>
    /// Represents database context extensions
    /// </summary>
    public static class RealitycsDbContextExtensions
    {
        #region Fields
        ...
        private static TEntity LoadEntityCopy<TEntity>(IRealitycsBaseContext context, TEntity entity, Func<EntityEntry<TEntity>, PropertyValues> getValuesFunction)
            where TEntity : RealitycsBase
        {
            if (context == null)
        ...
        private static IList<string> GetCommandsFromScript(string sql)
        {
            ...
            {
                if (string.IsNullOrWhiteSpace(batches[i]) || batches[i].StartsWith("GO", StringComparison.InvariantCultureIgnoreCase))
                    continue;

                var count = 1;
                if (i != batches.Length - 1 && batches[i + 1].StartsWith("GO", StringComparison.InvariantCultureIgnoreCase))
                {
        ...
        /// <param name="entity">Entity</param>
        /// <returns>Copy of the passed entity</returns>
        public static TEntity LoadOriginalCopy<TEntity>(this IRealitycsBaseContext context, TEntity entity) where TEntity : RealitycsBase
        {
        ...
        /// <param name="entity">Entity</param>
        /// <returns>Copy of the passed entity</returns>
        public static TEntity LoadDatabaseCopy<TEntity>(this IRealitycsBaseContext context, TEntity entity) where TEntity : RealitycsBase
        {
        ...
        public static void DropPluginTable(this IRealitycsBaseContext context, string tableName)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static string GetTableName<TEntity>(this IRealitycsBaseContext context) where TEntity : RealitycsBase
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static IEnumerable<(string Name, int? MaxLength)> GetColumnsMaxLength<TEntity>(this IRealitycsBaseContext context) where TEntity : RealitycsBase
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static IEnumerable<(string Name, decimal? MaxValue)> GetDecimalColumnsMaxValue<TEntity>(this IRealitycsBaseContext context)
            where TEntity : RealitycsBase
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static string DbName(this IRealitycsBaseContext context)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        /// <param name="context">Database context</param>
        /// <param name="sql">SQL script</param>
        public static void ExecuteSqlScript(this IRealitycsBaseContext context, string sql)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static void ExecuteSqlScriptFromFile(this IRealitycsBaseContext context, string filePath)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
