...
namespace RealityCS.DataLayer
{
    ...
    /// </summary>
    public partial interface IRealitycsDataProvider
    {
        #region Methods
        ...
        //TEntity InsertEntity<TEntity>(TEntity entity) where TEntity : RealitycsBase;
        ...
        ///// <typeparam name="TEntity">Entity type</typeparam>
        //void UpdateEntity<TEntity>(TEntity entity) where TEntity : RealitycsBase;
        ...
        ///// <typeparam name="TEntity">Entity type</typeparam>
        //void DeleteEntity<TEntity>(TEntity entity) where TEntity : RealitycsBase;
        ...
        ///// <typeparam name="TEntity">Entity type</typeparam>
        //void BulkDeleteEntities<TEntity>(IList<TEntity> entities) where TEntity : RealitycsBase;
        ...
        ///// <typeparam name="TEntity">Entity type</typeparam>
        //void BulkDeleteEntities<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : RealitycsBase;
        ...
        //void BulkInsertEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : RealitycsBase;
        ...
        //ITable<TEntity> GetTable<TEntity>() where TEntity : RealitycsBase;
        ...
        //int? GetTableIdent<TEntity>() where TEntity : RealitycsBase;
        ...
        //string BuildConnectionString(IRealitycsConnectionStringInfo nopConnectionString);
        ...
        //void SetTableIdent<T>(int ident) where T : RealitycsBase;
        ...
        //EntityDescriptor GetEntityDescriptor<TEntity>() where TEntity : RealitycsBase;
