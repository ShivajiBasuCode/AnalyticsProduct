...
export default function PublicHeader() {
    ...
    return <AppBar position="fixed" className={classes.publicHeader} >
        <Container maxWidth="xl" className={clsx(classes.menucontainer, classes.menucontainerpublic)}>
            <Box className={classes.menuWrapper} >
                ...
                <Box className={classes.rightMenu}>
                    <Box className={classes.righimgWrapper}>
                        <img
                            style={{ float: "right" }}
